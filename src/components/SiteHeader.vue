          ...
          <Transition name="image-panel">
            <div v-show="docsMenuOpen" id="docs-menu" class="image-popover docs-popover" role="menu">
              ...
              <router-link class="download-option image-option docs-option--claude" to="/claude-code-config/" role="menuitem" @click="docsMenuOpen = false">
                <span class="download-option-icon"><Terminal :size="19" aria-hidden="true" /></span>
              ...
              <router-link class="download-option image-option docs-option--harness" to="/deepseek-harness/" role="menuitem" @click="docsMenuOpen = false">
                <span class="download-option-icon"><Settings2 :size="19" aria-hidden="true" /></span>
...
import { ArrowUpRight, BookOpen, Building2, ChevronDown, Cloud, Images, Layers3, Settings2, WandSparkles, Workflow, Info, Terminal } from '@lucide/vue'
...
const isDocsSectionActive = computed(() => route.path.startsWith('/codex-help') || route.path.startsWith('/deepseek-harness') || route.path.startsWith('/workbuddy-config') || route.path.startsWith('/claude-code-config') || route.path.startsWith('/trae-config') || route.path.startsWith('/workflows') || route.path.startsWith('/skills'))
