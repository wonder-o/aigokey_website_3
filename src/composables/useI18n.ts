...
const copy = {
  zh: {
    ...
    navButtons: { toggle: 'EN', register: '注册', login: '登录', help: '帮助文档', enterprise: '企业服务', trial: '免费体验' },
    ...
    codexHelp: {
      meta: {
        ...
        description: 'AigoKey Codex 安装使用教程，包含非程序员和程序员用户的 Codex App、Codex CLI、CC-Switch、VS Code 插件安装和密钥导入流程。',
        keywords: 'Codex, 安装教程, CC-Switch, VS Code Codex 插件, 密钥导入, AigoKey',
        ogDescription: '按非程序员、Windows、Mac、程序员流程整理 Codex 安装与密钥导入教程。',
      },
      hero: {
        eyebrow: 'Codex App · CC-Switch · VS Code · AigoKey',
      ...
      nonDeveloper: {
        head: '非程序员用户安装流程',
        lead: '产品经理、电商运营、品牌营销、自媒体等用户，优先按这一段操作。安装 Codex App 后不要登录，直接退出程序，再通过 CC-Switch 导入密钥。',
        windowsHead: 'Windows 安装方法',
        macHead: 'Mac 安装方法',
        windowsSteps: [
          '下载安装 Codex App。安装好之后不要登录，直接退出程序。',
      ...
      developer: {
        head: '程序员用户安装流程',
        lead: '用于编程开发的用户再继续完成 CLI、CC-Switch、VS Code 插件和 Codex App 配置。',
        cliHead: '安装 Codex CLI',
        ccHead: '安装 CC-Switch 并导入密钥',
        ccText: '导入密钥后，记得在 CC-Switch 里启用刚导入的密钥，再回到 Codex App 或 VS Code 使用。',
        vscodeHead: '安装 VS Code Codex 插件',
        vscodeText: '如果你主要在 VS Code 里开发，可以安装 Codex 插件，并从侧边栏打开 Codex。',
        appHead: '安装 Codex App',
      },
      links: {
        app: 'Codex App：',
        ccSwitch: 'CC-Switch：',
  ...
  en: {
    ...
    navButtons: { toggle: '中文', register: 'Register', login: 'Log in', help: 'Help', enterprise: 'Enterprise', trial: 'Free Trial' },
    ...
    codexHelp: {
      meta: {
        ...
        description: 'AigoKey Codex installation guide for non-developer and developer users, covering Codex App, Codex CLI, CC-Switch, VS Code plugin installation, and key import.',
      ...
      nonDeveloper: {
        ...
        lead: 'Product managers, ecommerce operators, brand marketers, media creators, and similar users should start here. After installing Codex App, do not log in. Quit the app, then import the key through CC-Switch.',
        windowsHead: 'Windows installation',
        macHead: 'Mac installation',
        windowsSteps: [
          'Download and install Codex App. After installation, do not log in. Quit the app directly.',
          ...
          'Restart Codex App to start using it.',
        ],
        macSteps: [
          'Download and install Codex App. After installation, do not log in. Quit the app directly.',
      ...
      developer: {
        ...
        lead: 'Developer users can continue with CLI, CC-Switch, VS Code plugin, and Codex App configuration.',
        cliHead: 'Install Codex CLI',
        ccHead: 'Install CC-Switch and import the key',
        ccText: 'After importing the key, enable the imported key in CC-Switch, then return to Codex App or VS Code.',
      ...
      screenshots: {
        ...
        codexApp: [
          { src: '/assets/07_Codex_App主界面.png', alt: 'Codex App main screen', caption: 'Feishu screenshot 07: Codex App main screen' },
        ],
      },
      support: {
