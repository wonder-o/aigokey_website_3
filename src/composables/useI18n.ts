...
const copy = {
  zh: {
    ...
    navButtons: { toggle: 'EN', register: '注册', login: '登录', imageCreation: '图像创作', imageSkill: 'AGK生图skill', promptLibrary: '提示词库', modelServices: '模型服务', skills: 'Skills', workflows: '工作流', codexGuide: 'Codex安装教程', workflowCases: '工作流案例', skillsRadar: 'Skills雷达', cases: '案例库', blog: '博客', aboutGroup: '关于我们', about: '关于我们', download: '下载', downloadPanel: '下载资源', downloadCodex: 'ChatGPT Codex', downloadCodexMeta: 'OpenAI 官方下载', downloadHarness: 'DeepSeek Harness', downloadHarnessMeta: 'DeepSeek 官方', downloadWorkBuddy: 'WorkBuddy', downloadWorkBuddyMeta: '官方网站', downloadCcSwitch: 'CC-Switch', downloadCcSwitchMeta: '官方网站', help: '文档', volcengine: '火山引擎服务', enterpriseGroup: '企业服务', enterprise: '企业FDE服务', trial: '免费体验' },
  ...
  en: {
    ...
    navButtons: { toggle: '中文', register: 'Register', login: 'Log in', imageCreation: 'Image Studio', imageSkill: 'AGK Image Skill', promptLibrary: 'Prompts', modelServices: 'Model Services', skills: 'Skills', workflows: 'Workflows', codexGuide: 'Codex guide', workflowCases: 'Workflow cases', skillsRadar: 'Skills radar', cases: 'Cases', blog: 'Blog', aboutGroup: 'About us', about: 'About us', download: 'Downloads', downloadPanel: 'Downloads', downloadCodex: 'ChatGPT Codex', downloadCodexMeta: 'Official website', downloadHarness: 'DeepSeek Harness', downloadHarnessMeta: 'DeepSeek official', downloadWorkBuddy: 'WorkBuddy', downloadWorkBuddyMeta: 'Official website', downloadCcSwitch: 'CC-Switch', downloadCcSwitchMeta: 'Official website', help: 'Docs', volcengine: 'Volcengine Services', enterpriseGroup: 'Enterprise Services', enterprise: 'Enterprise FDE', trial: 'Free Trial' },
