...
const englishModelCopy: Record<string, ModelCopy> = {
  ...
  claude: { vendor: 'Anthropic', tagline: 'Reliable intelligence for complex reasoning, coding, and long-document work.', intro: 'Claude 4.5 models balance deep reasoning, coding ability, and natural conversation for long documents, complex analysis, and workflows that need steady progress.', capabilities: ['Complex reasoning and multi-step analysis', 'Code generation, review, and refactoring', 'Long-document understanding and natural-language collaboration'], planNote: 'A strong fit for research, writing, engineering, and high-quality team workflows.' },
